...
export function Contact() {
  ...
  const onSubmit = async (data: FormValues) => {
    // Fallback útil até ter endpoint: abre o e-mail do cliente
    const subject = encodeURIComponent(`Contato — ${data.name}`);
  ...
  return (
    <section id="contact" className="section-pad relative mx-auto max-w-7xl py-28">
      <div className="mb-12 max-w-3xl">
        ...
        <p className="mt-4 text-base leading-relaxed text-[#ffe81f]/55 md:text-lg">
          Aberto a oportunidades, freelance e ideias. Escolhe o canal ou manda
          uma mensagem.
        </p>
      </div>
          ...
          >
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className={cn(
                    fieldClass,
                    errors.email && "border-rose-400/50",
                  )}
                  autoComplete="email"
                />
                {errors.email && (
            ...
            <div className="flex flex-1 flex-col">
              ...
              <textarea
                ...
                rows={6}
                {...register("message")}
                placeholder="Conta um pouco sobre o projeto ou ideia…"
                className={cn(
                  fieldClass,
